...
public interface QuestionDao {
	 ...
	 * */
	int updateQuestion(Question question) throws SQLException;
	 ...
	 * */
	int deleteQuestion(Long questionId) throws SQLException;
	
	/**
	 * 질문 검색
	 * @param: Question question(질문 카테고리 아이디, 유저 아이디, 질문 아이디, 답변 현황 중 입력된 컬럼으로 검색)
	 * */
	List<Question> findQuestion(Question question) throws SQLException;
}
